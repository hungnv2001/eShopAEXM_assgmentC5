    ...
    public partial class no1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceItems_ProductVariants_ProductID",
                        column: x => x.ProductID,
                        principalTable: "ProductVariants",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceItemsReview", x => new { x.InvoiceItemID, x.InvoiceItemsID });
                    table.ForeignKey(
                        name: "FK_InvoiceItemsReview_InvoiceItems_InvoiceItemsID",
                        column: x => x.InvoiceItemsID,
                        principalTable: "InvoiceItems",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItemsReview_Review_InvoiceItemID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItemsReview_InvoiceItemsID",
                table: "InvoiceItemsReview",
